...
class DockAdmin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      stage: props.stage,
...
/* */
  ...
  handleTagUpdate(event) {
    ...
    const clsMthd = "DockAdmin.handleUpdate";
